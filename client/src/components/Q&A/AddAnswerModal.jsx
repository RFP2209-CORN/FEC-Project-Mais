      ...
      <div className="modal-styles">
        <form onSubmit={(e) => submitAnswer(e)}>
          ...
          <p className="answer-body">
            ...
            <textarea name="answer" maxLength="1000" rows="4" cols="50" />
          </p>

          <p className="answer-nickname">
            <label>What is your nickname:</label><br />
            <input type="text" name="name" size="60" maxLength="60" placeholder="Example: jackson11" />
            <br />
          ...
          <p className="answer-email">
            ...
            <input type="email" name="email" size="60" maxLength="60" placeholder="Example: jackson11@email.com" />
            <br />
